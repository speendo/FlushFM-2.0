...
// Audio
// ---------------------------------------------------------------------------
// Allowed AUDIO_VOLUME_STEPS range for ESP32-audioI2S: 21..255.
...
static constexpr uint8_t AUDIO_VOLUME_DEFAULT = 255;  // default to max volume at startup to account for manual volume pots and avoid confusion with no sound at all (mute) on first boot
